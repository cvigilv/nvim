...
vim.keymap.set("n", "<leader>fz", search_headings, vim.tbl_extend("keep", opts, { desc = "Search notes by headings" }))
vim.keymap.set("n", "<leader>fZ", search_notes, vim.tbl_extend("keep", opts, { desc = "Search notes by content" }))
