" ============================================================================
" Tempano, my own modified version of Iceberg colorscheme
" Original: https://github.com/cocopon/iceberg.vim
" Modified by: Carlos Vigil-Vásquez
" Date: 2025-02-23
" ============================================================================
"
" Original header:
...
if &background == 'light'
  ...
  hi NonText ctermfg=244 guifg=#8389a3 cterm=italic gui=italic
  hi Whitespace ctermfg=251 guifg=#cbcfda cterm=italic gui=italic
  ...
  hi StatusLine cterm=reverse ctermbg=252 ctermfg=243 gui=reverse guibg=#e8e9ec guifg=#8b98b6 term=reverse
  hi StatusLineTerm cterm=reverse ctermbg=252 ctermfg=243 gui=reverse guibg=#e8e9ec guifg=#8b98b6 term=reverse
  ...
  hi TabLineFill ctermbg=white ctermfg=237 guibg=#ffffff guifg=#33374c
  hi TabLineSel cterm=bold ctermbg=254 ctermfg=237 gui=bold guibg=#e8e9ec guifg=#606374
  ...
  hi NonText ctermfg=242 guifg=#6b7089 cterm=italic gui=italic
  ...
  hi TabLineFill ctermbg=black ctermfg=252 guibg=#000000 guifg=#c6c8d1
  ...
  if has('nvim')
    ...
    let g:terminal_ansi_colors = ['#111111', '#e27878', '#b4be82', '#e2a478', '#84a0c6', '#a093c7', '#89b8c2', '#c6c8d1', '#6b7089', '#e98989', '#c0ca8e', '#e9b189', '#91acd1', '#ada0d3', '#95c4ce', '#d2d4de']
  endif
endif
...
hi! link GitGutterChanged DiffChange
